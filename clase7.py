...
st.set_page_config(page_title="Chatea con IA", page_icon="🐼")
# Título de la aplicación
st.title("Welcom in the world")  # se puede modificar 
...
## DESAFIO SOLO MANDAR UNA CAPTURA
...
def area_chat():
#Generamos un container que va a guardar el historial el historial del chat
     contenedorDelChat = st.container(height=400,border=True)
#Abrimos el contenedor del chat y mostramos el historial.
     with contenedorDelChat:
          mostrar_historial()    

# Creo una funcion main donde voy a ir agrupando todas la funciones de mi codigo para que corra
# todo desde una misma funcion 
...
#clase 8 ajustes de paletas de colores para el chat 
